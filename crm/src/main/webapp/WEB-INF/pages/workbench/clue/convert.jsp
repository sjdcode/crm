...
<script type="text/javascript">
	$(function(){
		...
		$("#queryActivityInput").keyup(function (){
			//收集参数
			var clueId='${clue.id}';
			var dimName=$("#queryActivityInput").val();

			//发送请求
			$.ajax({
				url:"workbench/clue/queryConvertActivityList.do",
				data:{
					dimName:dimName,
					clueId:clueId
				},
				...
				success:function (data){
					...
					$.each(data,function (index,obj){
						activityListStr+="<tr>";
						activityListStr+="<td><input type=\"radio\" value=\""+obj.id+"\" activityName=\""+obj.name+"\" name=\"activity\"/></td>";
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="queryActivityInput" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
		...
		<form>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <select id="stage"  class="form-control">
				...
				<c:forEach items="${dicValue}" var="dic">
					<option value="${dic.id}">${dic.value}</option>
				</c:forEach>
		    </select>
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activityName">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="queryActivityBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
